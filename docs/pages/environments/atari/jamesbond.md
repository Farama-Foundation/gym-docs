...
grid:
   ...
   - Observation Low: 0
   - Import: <code>gym.make("ALE/Jamesbond-v5")</code>
---
...
The versions v0 and v4 are not contained in the "ALE" namespace. I.e. they are instantiated via `gym.make("Jamesbond-v0")`.
