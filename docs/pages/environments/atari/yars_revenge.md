...
grid:
   ...
   - Observation Low: 0
   - Import: <code>gym.make("ALE/YarsRevenge-v5")</code>
---

### Description
Your goal is to break a path through the shield, and destroy Qotile with a blast from the Zorlon Cannon. Detailed documentation can be found on [the AtariAge page](https://atariage.com/manual_thumbs.php?SoftwareLabelID=603).
...
The versions v0 and v4 are not contained in the "ALE" namespace. I.e. they are instantiated via `gym.make("YarsRevenge-v0")`
