...
Before learning how to create your own environment you should check out [the documentation of Gym's API](https://www.gymlibrary.dev/api/core/).
...
Check out the [wrapper documentation](https://www.gymlibrary.dev/api/wrappers/) for details on how to 
...
In the section on [ObservationWrappers](https://www.gymlibrary.dev/api/wrappers/#observationwrapper) we have implemented
