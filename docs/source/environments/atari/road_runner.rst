...
to run in and times to jumps. The goal is to outrun Wile E. Coyote(TM)
while avoiding the hazards of the desert.

The game begins with three lives. You lose a life when the coyote
catches you, picks you up in a rocket, or shoots you with a cannon. You
also lose a life when a truck hits you, you hit a land mine, you fall
off a cliff, or you get hit by a falling rock.

You score points (i.e. rewards) by eating seeds along the road, eating
steel shot, and destroying the coyote.

Detailed documentation can be found on `the AtariAge
page <https://atariage.com/manual_html_page.php?SoftwareLabelID=412>`__
...
+-------------------------------+-------+------------+-----------------+
| Environment                   | Valid | Valid      | Default Mode    |
|                               | Modes | Di         |                 |
|                               |       | fficulties |                 |
+===============================+=======+============+=================+
| RoadRunner                    | ``    | ``[0]``    | ``0``           |
