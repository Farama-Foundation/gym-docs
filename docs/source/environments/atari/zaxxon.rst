...
Your goal is to stop the evil robot Zaxxon and its armies from enslaving
the galaxy by piloting your fighter and shooting enemies. Detailed
documentation can be found on `the AtariAge
page <https://atariage.com/manual_html_page.php?SoftwareLabelID=606>`__.
...
+-------------+--------------+--------------+--------------+
| Environment | Valid Modes  | Difficulties | defaultMode  |
+=============+==============+==============+==============+
| Zaxxon      | ``[0]``      | ``[0]``      | ``0``        |
+-------------+--------------+--------------+--------------+
