...
Your goal is to rack up points by finding treasures in the mazes of the
tomb while eliminating its guardians. Detailed documentation can be
found on `the AtariAge
page <https://atariage.com/manual_thumbs.php?SoftwareLabelID=572>`__.
