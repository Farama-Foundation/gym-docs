...
You control a space-ship that travels forward at a constant speed. You
can only steer it sideways between discrete positions. Your goal is to
destroy enemy ships, avoid their attacks and dodge space debris.
Detailed documentation can be found on `the AtariAge
page <https://atariage.com/manual_thumbs.php?SystemID=2600&SoftwareID=860&itemTypeID=MANUAL>`__
...
You score points for destroying enemies. For a more detailed
