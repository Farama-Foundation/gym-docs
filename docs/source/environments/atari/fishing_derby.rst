...
your objective is to catch more sunfish than your opponent. But it’s not
just between you and the other fisherman, as a big, black shark is
lurking just below the surface, waiting to steal your catch! Detailed
documentation can be found on `the AtariAge
page <https://atariage.com/manual_html_page.php?SoftwareID=182>`__.
...
`AtariAge <https://atariage.com/manual_html_page.php?SoftwareID=182>`__.
