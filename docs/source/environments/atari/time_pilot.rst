...
You control an aircraft. Use it to destroy your enemies. As you progress
in the game, you encounter enemies with technology that is increasingly
from the future. More details can be found on `the Atari Mania
page <http://www.atarimania.com/game-atari-2600-vcs-time-pilot_8038.html>`__
...
You score points for destroying enemies, gaining more points for
difficult enemies. For a more detailed documentation, see `the Atari
Mania
page <http://www.atarimania.com/game-atari-2600-vcs-time-pilot_8038.html>`__.
